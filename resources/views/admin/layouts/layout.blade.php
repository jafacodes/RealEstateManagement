...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"> تحكم </span>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ Request::root() }}/admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ Request::root() }}/admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ Request::root() }}/admin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header" style="font-size: 18px;color:tomato;">
