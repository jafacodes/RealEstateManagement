...
@section('header')
    ...
    {!! Html::style('admin/plugins/datatables/jquery.dataTables.min.css') !!}
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"> التحكم في الأعضاء </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="data" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="margin: 5px" href="{ url('adminpanel/users/'.$user->id.'/edit') }"><label class="label label-primary"><i class="fa fa-btn small fa-edit"></i> تعديل </label></a>
                                        <a style="margin: 5px" href="{ url('adminpanel/users/'.$user->id.'/delete') }"><label class="label label-danger"><i class="fa fa-btn small fa-remove"></i> حذف </label></a>
                                    </td>
                                </tr>
                                    endforeach
                                !-->
