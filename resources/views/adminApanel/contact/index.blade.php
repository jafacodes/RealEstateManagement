...
رسائل الموقع
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="{{ url('/admin_panel/contacts') }}"> رسائل الموقع  </a></li>
            </ul>
        </div>
    </div>
    ...
    <!-- page script -->
            ...
            <script type="text/javascript">
                ...
                $('#data thead th').each( function () {
                    if($(this).index()  < 4 ){
                        var title = $(this).html();
                        $(this).html( '<input type="search" style="width: 100% !important;" class="form-control input-sm" data-value="'+ $(this).index() +'" placeholder=" البحث '+title+'" />' );
                        ...
                        $(this).html( '<select><option value="0"> رسائل جديدة </option><option value="1"> رسائل قديمة </option></select>' );
                    }
